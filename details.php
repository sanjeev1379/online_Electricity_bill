...
<body>
  ...
  ?>
       ...
       <div class="modal-footer">
         <a href="card.php?q=<?php echo $u_username ?>&bill_no=<?php echo $bill_no ?>" style="text-decoration:none;"><input type="submit" name="make_payment" id="bt" class="btn btn-primary btn-block" value="Payment"  style="width:44%; margin-left:38%;"/></a>
       </div>
      </center>
