...
<html lang="en">
<head>
  <title>Electrity Bill | View Feedback</title>
  <meta charset="utf-8" />
    ...
    <div class="container">
      <div class="navbar-collapse" id="mainNavBar">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="active"><a id="left" href="#">View Feedback</a></li>
      ...
      <center>
        <div class="modal-content">
          <div class="modal-header">
            <h2 class="modal-title" id="log" style="margin-left:4%;">View Feedback :</h2>
          </div>
         ...
         <thead>
           <tr>
             ...
             <td id="k" style="color:white;">Feedback</td>
           </tr>
         </thead>
       </table>
       ...
       <?php
        ...
        global $con;
          $valid="true";
          $get_pro="select * from registation where `feedback_status`='$valid'";
