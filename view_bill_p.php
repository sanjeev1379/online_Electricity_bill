    ...
    <div class="container">
      <div class="navbar-collapse" id="mainNavBar" style="margin-right:3%;">
        <ul class="nav navbar-nav navbar-right">
          <li class="active"><a id="left" href="view_bill_p.php?q=<?php echo $u_username ?>">View Bill</a></li>
      ...
      <center>
        <div class="modal-content">
          <div class="modal-header">
            <h2 class="modal-title" id="log" style="margin-left:5%">View Bill :</h2>
          </div>
       ...
       <?php
        ...
        global $con;
          ...
          $get_pro="select bill_no,username,bill_name,name,address,mobile_no,month,unit_consumed,status from registation, bill where registation.username=bill.bill_name AND bill.bill_name='$u_username'";
          $run_pro=mysqli_query($con,$get_pro);
              while($row_pro=mysqli_fetch_array($run_pro)){
    //$pro_student_id=$row_pro['student_id'];
                 $pro_bill_no=$row_pro['bill_no'];
                  $pro_name=$row_pro['name'];
                  $pro_username=$row_pro['username'];
